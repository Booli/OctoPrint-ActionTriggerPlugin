...
plugin_identifier = "actiontrigger"
...
# plugin module
plugin_name = "OctoPrint-ActionTriggerPlugin"

# The plugin's version. Can be overwritten within OctoPrint's internal data via __plugin_version__ in the plugin module
plugin_version = "1.1.1rc1"

# The plugin's description. Can be overwritten within OctoPrint's internal data via __plugin_description__ in the plugin
# module
plugin_description = "Hooks to specific serial commands from the printer. Actions are handled accordingly"

# The plugin's author. Can be overwritten within OctoPrint's internal data via __plugin_author__ in the plugin module
plugin_author = "Pim Rutgers"

# The plugin's author's mail address.
plugin_author_email = "pim.rutgers@gmail.com"

# The plugin's homepage URL. Can be overwritten within OctoPrint's internal data via __plugin_url__ in the plugin module
plugin_url = "https://github.com/Booli/OctoPrint-ActionTriggerPlugin"
